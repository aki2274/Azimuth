...
def read_V1_data(data_file, learn_options, AML_file=None):
    if data_file is None:
         data_file = importlib.resources.files(azimuth) / "data" / "V1_data.xlsx"

    if AML_file is None:
        #"data/V1_suppl_data.txt"
        AML_file = importlib.resources.files(azimuth) / "data" / "V1_suppl_data.txt"
...
def read_V2_data(data_file, learn_options=None, verbose=True):
    if data_file is None:
        data_file = importlib.resources.files(azimuth) / "data" / "V2_data.xlsx"
